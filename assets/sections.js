...
import { EffectCarousel } from "//divoom.com/cdn/shop/t/100/assets/theme.js?v=21473378756751850121720604192";
...
import { timeline as timeline2, inView } from "//divoom.com/cdn/shop/t/100/assets/vendor.min.js?v=52426788336887041471720604192";
...
import { Delegate } from "//divoom.com/cdn/shop/t/100/assets/vendor.min.js?v=52426788336887041471720604192";
...
import { animate, timeline as timeline3, stagger, Delegate as Delegate2 } from "//divoom.com/cdn/shop/t/100/assets/vendor.min.js?v=52426788336887041471720604192";
import { AnimatedDetails, EffectCarousel as EffectCarousel2, Drawer, throttle } from "//divoom.com/cdn/shop/t/100/assets/theme.js?v=21473378756751850121720604192";
...
var StoreHeader = class extends HTMLElement {
  ...
  async hide() {
    if (this._isVisible) {
      ...
      await animate(this, { transform: ["translateY(0)", "translateY(-100%)"] }, { duration: 0.2, easing: "ease" }).finished;
...
import { animate as motionAnimate, scroll } from "//divoom.com/cdn/shop/t/100/assets/vendor.min.js?v=52426788336887041471720604192";
...
import { scroll as scroll2, timeline as timeline4, animate as animate2, inView as inView2 } from "//divoom.com/cdn/shop/t/100/assets/vendor.min.js?v=52426788336887041471720604192";
import { imageLoaded, getHeadingKeyframe } from "//divoom.com/cdn/shop/t/100/assets/theme.js?v=21473378756751850121720604192";
...
import { ScrollArea } from "//divoom.com/cdn/shop/t/100/assets/theme.js?v=21473378756751850121720604192";
...
import { animate as animate3, timeline as timeline5, inView as inView3 } from "//divoom.com/cdn/shop/t/100/assets/vendor.min.js?v=52426788336887041471720604192";
import { getHeadingKeyframe as getHeadingKeyframe2, throttle as throttle2 } from "//divoom.com/cdn/shop/t/100/assets/theme.js?v=21473378756751850121720604192";
...
import { animate as animate4, inView as inView4 } from "//divoom.com/cdn/shop/t/100/assets/vendor.min.js?v=52426788336887041471720604192";
...
import { timeline as timeline6, inView as inView5 } from "//divoom.com/cdn/shop/t/100/assets/vendor.min.js?v=52426788336887041471720604192";
...
import { animate as animate5, timeline as timeline7, inView as inView6 } from "//divoom.com/cdn/shop/t/100/assets/vendor.min.js?v=52426788336887041471720604192";
import { imageLoaded as imageLoaded2 } from "//divoom.com/cdn/shop/t/100/assets/theme.js?v=21473378756751850121720604192";
...
import { timeline as timeline8, animate as animate6, stagger as stagger2, inView as inView7 } from "//divoom.com/cdn/shop/t/100/assets/vendor.min.js?v=52426788336887041471720604192";
import { EffectCarousel as EffectCarousel3, imageLoaded as imageLoaded3, getHeadingKeyframe as getHeadingKeyframe3 } from "//divoom.com/cdn/shop/t/100/assets/theme.js?v=21473378756751850121720604192";
...
var MultipleImagesWithTextContentList = class extends EffectCarousel3 {
  ...
  _transitionTo(fromSlide, toSlide, { direction = "next", animate: animate9 = true } = {}) {
    ...
    ], { duration: animate9 ? parseFloat(this.getAttribute("fade-speed") || 0.5) : 0 }).finished;
  }
};
...
import { Drawer as Drawer2 } from "//divoom.com/cdn/shop/t/100/assets/theme.js?v=21473378756751850121720604192";
...
import { timeline as timeline9, animate as animate7, inView as inView8 } from "//divoom.com/cdn/shop/t/100/assets/vendor.min.js?v=52426788336887041471720604192";
import { EffectCarousel as EffectCarousel4 } from "//divoom.com/cdn/shop/t/100/assets/theme.js?v=21473378756751850121720604192";
...
import { extractSectionId } from "//divoom.com/cdn/shop/t/100/assets/theme.js?v=21473378756751850121720604192";
...
import { scroll as scroll3, timeline as timeline10, ScrollOffset, inView as inView9 } from "//divoom.com/cdn/shop/t/100/assets/vendor.min.js?v=52426788336887041471720604192";
...
import { animate as animate8, scroll as scroll4 } from "//divoom.com/cdn/shop/t/100/assets/vendor.min.js?v=52426788336887041471720604192";
...
import { animate as motionAnimate2, timeline as timeline11, inView as inView10 } from "//divoom.com/cdn/shop/t/100/assets/vendor.min.js?v=52426788336887041471720604192";
import { EffectCarousel as EffectCarousel5, imageLoaded as imageLoaded4, getHeadingKeyframe as getHeadingKeyframe4 } from "//divoom.com/cdn/shop/t/100/assets/theme.js?v=21473378756751850121720604192";
...
var SlideshowCarousel = class extends EffectCarousel5 {
  ...
  connectedCallback() {
    ...
    if (this._player && this.hasAttribute("autoplay")) {
      this._player.addEventListener("player:start", (event) => {
        ...
        if (cursorRing) {
          const cursorRingAnimationControl = motionAnimate2(cursorRing, { strokeDasharray: [`0px, ${cursorRing.getTotalLength()}px`, `${cursorRing.getTotalLength()}px, ${cursorRing.getTotalLength()}px`] }, {
        ...
        circles.forEach((item) => {
          ...
          if (item.getAttribute("aria-current") === "true") {
            circleAnimationControl = motionAnimate2(circle, { strokeDasharray: [`0px, ${circle.getTotalLength()}px`, `${circle.getTotalLength()}px, ${circle.getTotalLength()}px`] }, { duration: event.detail.duration, easing: "linear" });
          } else {
            circleAnimationControl = motionAnimate2(circle, { strokeDasharray: `${circle.getTotalLength()}px, ${circle.getTotalLength()}px` }, { duration: 0, easing: "linear" });
          }
   ...
   */
  async _transitionTo(fromSlide, toSlide, { direction, animate: animate9 = true } = {}) {
    fromSlide.classList.remove("is-selected");
    toSlide.classList.add("is-selected");
    let timelineControls = null;
    switch (this.transitionType) {
      case "fade":
        timelineControls = this._fade(fromSlide, toSlide, { animate: animate9 });
        break;
      case "fade_with_text":
        timelineControls = this._fadeWithText(fromSlide, toSlide, { animate: animate9 });
        break;
    }
    if (!animate9) {
